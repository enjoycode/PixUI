...
import { exceptions, simd } from "../consts";

// import gitHash from "consts:gitHash";
import { gitHash } from "../consts";
...
import type { MonoConfig, RuntimeAPI } from "../types/index1";
...
export function setLoaderGlobals (
    ...
    const lh: Partial<LoaderHelpers> = {
        ...
        wasmCompilePromise: createPromiseController<string/*WebAssembly.Module*/>(),
