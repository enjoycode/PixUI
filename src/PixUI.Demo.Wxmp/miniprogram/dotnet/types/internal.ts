...
import type { AssetEntry, DotnetModuleConfig, LoadBootResourceCallback, LoadingResource, MonoConfig, RuntimeAPI, SingleAssetBehaviors } from "./index1";
...
export type LoaderHelpers = {
    ...
    //Rick wasmCompilePromise: PromiseAndController<WXWebAssembly.Module>,
    wasmCompilePromise: PromiseAndController<string>,
