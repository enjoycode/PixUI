...
import type { CreateDotnetRuntimeType, DotnetHostBuilder, DotnetModuleConfig, RuntimeAPI, MonoConfig, ModuleAPI, AssetEntry, GlobalizationMode, AssetBehaviors } from "./index1";
import type { EmscriptenModule } from "./emscripten";
import type { dotnet, exit } from "../loader/index1";
