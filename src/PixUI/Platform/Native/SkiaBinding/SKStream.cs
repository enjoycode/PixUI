...
namespace PixUI
{
    public unsafe abstract class SKStream : SKObject
    {
        ...
        public int Position
        {
            get { return (int)SkiaApi.sk_stream_get_position(Handle); }
            set { Seek(value); }
        }
            ...
            : base(CreateNew(path), true)
        {
            if (Handle == IntPtr.Zero)
            {
                throw new InvalidOperationException(
                    "Unable to create a new SKFileStream instance.");
            }
        }
    ...
    public unsafe class SKMemoryStream : SKStreamMemory
    {
            ...
            : this(SkiaApi.sk_memorystream_new(), true)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Unable to create a new SKMemoryStream instance.");
            }
        }
    ...
    public unsafe abstract class SKWStream : SKObject
    {
        ...
        {
            get { return (int)SkiaApi.sk_wstream_bytes_written(Handle); }
        }
    ...
    public unsafe class SKFileWStream : SKWStream
    {
            ...
            : base(CreateNew(path), true)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Unable to create a new SKFileWStream instance.");
            }
        }
    ...
    public unsafe class SKDynamicMemoryWStream : SKWStream
    {
        ...
        public SKStreamAsset DetachAsStream()
        {
            return SKStreamAssetImplementation.GetObject(
                SkiaApi.sk_dynamicmemorywstream_detach_as_stream(Handle));
        }
