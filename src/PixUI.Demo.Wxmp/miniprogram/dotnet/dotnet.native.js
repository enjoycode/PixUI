...
var createDotnetRuntime = (() => {
    var _scriptDir = globalThis.bootUrl;
    ...
    return (
        async function (moduleArg = {}) {
            ...
            // include: /usr/local/share/dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/9.0.4/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
            ...
            // end include: /usr/local/share/dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/9.0.4/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
            ...
            console.log("ENVIRONMENT_IS_NODE", ENVIRONMENT_IS_NODE);
            console.log("ENVIRONMENT_IS_SHELL", ENVIRONMENT_IS_SHELL);
            ...
            if (ENVIRONMENT_IS_NODE) {
                ...
                /** @suppress{duplicate} */
                var require = createRequire(globalThis.bootUrl);
                ...
                if (ENVIRONMENT_IS_WORKER) {
                    ...
                    // EXPORT_ES6 + ENVIRONMENT_IS_NODE always requires use of globalThis.bootUrl,
                    // since there's no way getting the current absolute path of the module when
                    // support for that is not available.
                    scriptDirectory = require('url').fileURLToPath(new URL('./', globalThis.bootUrl)); // includes trailing slash
                }
            ...
            function initRuntime() {
                ...
                console.log("native.initRuntime: FS")
                if (!Module['noFSInit'] && !FS.init.initialized)
                    FS.init();
                FS.ignorePermissions = false;

                console.log("native.initRuntime: TTY")
                TTY.init();
            ...
            if (Module['locateFile']) {
                ...
                if (ENVIRONMENT_IS_SHELL)
                    ...
                    // Use bundler-friendly `new URL(..., globalThis.bootUrl)` pattern; works in browsers too.
                    wasmBinaryFile = new URL('dotnet.native.wasm', globalThis.bootUrl).href;
            }
            ...
            DOTNET.setup({ wasmEnableSIMD: true, wasmEnableEH: false, enableAotProfiler: false, enableBrowserProfiler: false, enableLogProfiler: false, runAOTCompilation: false, wasmEnableThreads: false, gitHash: "f57e6dc747158ab7ade4e62a75a6750d16b771e8", });;
            var wasmImports = {
                /** @export */
