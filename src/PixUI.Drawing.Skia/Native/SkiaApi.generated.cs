...
public unsafe partial class SkiaApi
{
	...
	[DllImport (SKIA, CallingConvention = CallingConvention.Cdecl)]
	internal static extern void sk_canvas_flush (sk_canvas_t param0);
	...
	[DllImport (SKIA, CallingConvention = CallingConvention.Cdecl)]
	internal static extern sk_image_t sk_image_new_from_adopted_texture (gr_recording_context_t context, gr_backendtexture_t texture, SurfaceOrigin origin, SKColorTypeNative colorType, AlphaType alpha, sk_colorspace_t colorSpace);
	...
	[DllImport (SKIA, CallingConvention = CallingConvention.Cdecl)]
	internal static extern sk_image_t sk_image_new_from_texture (gr_recording_context_t context, gr_backendtexture_t texture, SurfaceOrigin origin, SKColorTypeNative colorType, AlphaType alpha, sk_colorspace_t colorSpace, SKImageTextureReleaseProxyDelegate releaseProc, void* releaseContext);
	...
	[DllImport(SKIA, CallingConvention = CallingConvention.Cdecl)]
	internal static extern sk_typeface_t sk_typeface_make_from_data(sk_data_t cdata);
