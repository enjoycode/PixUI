...
public abstract class NativeWindow : UIWindow
{
    ...
    protected internal sealed override ICanvas GetOnscreenCanvas() => WindowContext!.GetOnScreenCanvas();

    protected internal sealed override ICanvas GetOffscreenCanvas() => WindowContext!.GetOffScreenCanvas();
    ...
    public void OnResize(int width, int height)
    {
        ...
        //加入无效队列，准备重新布局并绘制
        RootWidget.ResetAvailableSize(new(Width, Height));
